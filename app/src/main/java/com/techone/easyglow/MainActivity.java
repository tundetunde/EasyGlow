...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent i = new Intent("com.techone.easyglow.SETTINGS");
            startActivity(i);
            return true;
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.listFollowers) {

        } else if (id == R.id.listTrendingVids) {

        } else if (id == R.id.listSettings) {
            i = new Intent("com.techone.easyglow.SETTINGS");
            startActivity(i);
        } else if (id == R.id.listHelp) {
            i = new Intent("com.techone.easyglow.HELP");
            startActivity(i);
